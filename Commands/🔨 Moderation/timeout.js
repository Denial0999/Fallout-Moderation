...
module.exports = {
    category: "timeout",
    description: "Set a users timeout",
            ...
            switch (options.getSubcommand()) {
                case "mute": {
                    if (target.id === interaction.member.id)
                        ...
                        embeds: [new MessageEmbed().setTitle("❌ Error ❌").setColor(`DARK_PURPLE`)
                    ...
                    target.timeout(timeInMs, reason);
                        return interaction.reply({
                        embeds: [new MessageEmbed().setColor(`DARK_PURPLE`).setTitle(`Successfully Muted!`)
                            .addFields({
                            name: "User:",
                ...
                case "unmute": {
                    ...
                    if(!target.communicationDisabledUntilTimestamp)
                        ...
                        return interaction.reply({
                        embeds: [new MessageEmbed().setColor(`DARK_PURPLE`).setTitle("Successfully Unmuted!")
                            .addFields({
                            name: "User:",
                            value: `\`\`\`${target.user.username}\`\`\``
                        },
